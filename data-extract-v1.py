...
if __name__ == "__main__":
    folder_path = 'D:\\Coursera Courses (NVME)\\LLM freecodecamp\\LLM-fcc-intro-to-llms\\openwebtext'
    ...
    # Combine vocab and write to vocab.txt
